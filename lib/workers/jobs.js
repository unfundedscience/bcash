...
/**
 * Execute secp256k1.schnorrVerify() on worker.
 * @see secp256k1.schnorrVerify
 * @param {TX} tx
 * @param {VerifyFlags} flags
 * @returns {Boolean}
 */

jobs.schnorrVerify = function schnorrVerify(msg, sig, key) {
...
/**
 * Execute secp256k1.schnorrSign() on worker.
 * @see secp256k1.schnorrSign
 * @param {TX} tx
 * @param {Number} index
 * @param {VerifyFlags} flags
 * @returns {Boolean}
...
jobs.schnorrSign = function schnorrSign(msg, key) {
