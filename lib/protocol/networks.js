...
main.seeds = [
  ...
  'seed.bchd.cash',    // BCHD
  'seed-bch.bitcoinforks.org' // Bitcoinforks Seeder
];
...
main.pow = {
  ...
  chainwork: new BN(
    '0000000000000000000000000000000000000000012e4a08418af4cae813d0bb',
    'hex'
  ),
...
testnet.pow = {
  ...
  bits: 486604799,
  chainwork: new BN(
    '000000000000000000000000000000000000000000000058561ff2091294ecc0',
    'hex'
  ),
  targetTimespan: 14 * 24 * 60 * 60,
  targetSpacing: 10 * 60,
